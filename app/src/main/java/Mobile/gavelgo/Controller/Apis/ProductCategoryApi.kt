...
class ProductCategoryApi {
    ...
    fun productcategory_const(context: Context, productcategory_callback: ProductCategory_CallBack) {
        ...
        val call = apiInterface.getCategory()
    ...
    fun productSubcategory_const(context: Context, productcategory_callback: ProductCategory_CallBack) {
        this.context = context
        this.productcategory_callback = productcategory_callback
        ...
        val apiInterface = APIClient.getClient(ApiInterface.BASE_URL)!!.create(ApiInterface::class.java)
        val call = apiInterface.getSubcategories()
